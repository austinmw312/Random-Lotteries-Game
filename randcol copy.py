...
while (abs(exp_val_v1 - exp_val_v2) > 3) or (exp_val_v1 > 80) \
    ...
    or (abs(outcome_uncertainty_v1 - outcome_uncertainty_v2) > 130) \
    or (num_blues_v1 == num_reds_v2 and blue_value_v1 == red_value_v2) \
    or (blue_value_v1 == red_value_v2 or blue_value_v2 == red_value_v1):
...
# make four rows of 5 marbles each for lottery layout
vase1 = []
n = 4
i = 0
...
# print("Num reds: {}".format(num_reds_v1))
print("{} reds, red = {} pts".format(num_reds_v1, red_value_v1))
#print("blue = {} pts, red = {} pts".format(blue_value_v1, red_value_v1))
#print("Red = {} pts".format(red_value_v1))
...
#print("Num reds: {}".format(num_reds_v2))
print("{} reds, red = {} pts".format(num_reds_v2, red_value_v2))
#print("blue = {} pts, red = {} pts".format(blue_value_v2, red_value_v2))
#print("Red = {} pts".format(red_value_v2))
